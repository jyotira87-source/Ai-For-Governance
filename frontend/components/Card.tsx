...
export function Card({
  ...
  return (
    <div className={`glass relative overflow-hidden rounded-2xl p-5 shadow-soft transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_30px_90px_rgba(0,0,0,0.65)] ${className}`}>
